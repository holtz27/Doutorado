...
trace_plots(theta,
            burn = 0, lags = 1,
            names = c('mu', 'phi_h', 's_h', 'a1', 'phi_a', 's_a', 'v') )
#dev.off()

# Numeric Analysis
summary = rstan::summary( draws )$summary[c('mu', 'phi_h', 's_h', 'a1', 'phi_a', 's_a', 'v'), 
...
plot( h, type = 'l', col = 'red', ylim = c(-10, 10) )
lines( h_hat, type = 'l')
