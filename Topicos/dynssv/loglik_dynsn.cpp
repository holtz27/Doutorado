...
// [[Rcpp::export]]
List loglik_dynsn(vec y, vec theta, int N){
  ...
  Ms = moms(a_par.col(0), h_par.col(0), N);
  ...
  for(int t=1; t<T; t++){
    ...
    Ms = moms(a_par.col(t), h_par.col(t), N);
