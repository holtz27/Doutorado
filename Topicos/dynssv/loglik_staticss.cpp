...
mat moms(double a, vec h, double v, int N){
  
  mat M(N, 2);
  
  double invsqrt_U = 2*v/(2*v-1);
...
// [[Rcpp::export]]
List loglik_staticss(vec y, vec theta, int N){
