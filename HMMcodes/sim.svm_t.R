...
for(m in c(50,100,150,200)){
  ...
  optim_time[[i]] = res.svmt200_4_s1$time
  weigth_time[[i]] = time
  i = i + 1
}
save(Results, optim_time, weigth_time, file = 'touts.1500.RData')
################################################################################
Results = optim_time = weigth_time = list()
i=1
s1=3000
...
save(Results, optim_time, weigth_time, file = 'touts.3000.RData')
################################################################################
Results = optim_time = weigth_time = list()
i=1
s1=6000
...
save(Results, optim_time, weigth_time, file = 'touts.6000.RData')
